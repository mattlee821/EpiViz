...
circos_plot <- function(track_number,
  ...
  ## Colours
  colours <- names(wesanderson::wes_palettes)
  discrete_palette <- wesanderson::wes_palette(colours[8], type = "discrete")
  ...
  point_col1 <- discrete_palette[3]
  point_bg1 <- "white"
  point_col1_sig <- "white"
  point_bg1_sig <- discrete_palette[3]

  point_col2 <- discrete_palette[1]
  point_bg2 <- "white"
  point_col2_sig <- "white"
  point_bg2_sig <- discrete_palette[1]

  point_col3 <- discrete_palette[5]
  point_bg3 <- "white"
  point_col3_sig <- "white"
  point_bg3_sig <- discrete_palette[5]

  point_col4 <- discrete_palette[4]
  point_bg4 <- "white"
  point_col4_sig <- "white"
  point_bg4_sig <- discrete_palette[4]

  ## confidence intervals
  ci_lwd <- 5
  ci_lty <- 1
  ci_col1 <- discrete_palette[3]
  ci_col2 <- discrete_palette[1]
  ci_col3 <- discrete_palette[5]
  ci_col4 <- discrete_palette[4]

  ## lines specifics
  lines_col1 <- discrete_palette[3]
  lines_col2 <- discrete_palette[1]
  lines_col3 <- discrete_palette[5]

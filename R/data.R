#' Example data: Simulated epidemiology results for track 1
#'
...
#'   \item{subgroup}{Minor category/grouping}
...
#' Example data: Simulated epidemiology results for track 2
#'
#' A simulated dataset of effect estimates and confidence intervals for 120 variables.
#'
#' @format A data frame with 120 rows and 8 variables.
...
#' Example data: Simulated epidemiology results for track 3
#'
#' A simulated dataset of effect estimates and confidence intervals for 120 variables.
#'
#' @format A data frame with 120 rows and 8 variables.

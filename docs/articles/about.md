...
**EpiViz** is an R package designed to streamline the creation of Circos
plots specifically for epidemiologists. It acts as a high-level wrapper
around the powerful `circlize` and `ComplexHeatmap` packages.
